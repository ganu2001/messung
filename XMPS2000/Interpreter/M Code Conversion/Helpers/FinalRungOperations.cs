    ...
    public class FinalRungOperations
    {
        public static async void TestOperation(string expression)
        {
            ...
            for (var i = 0; i < rungList.Count; i++)
            {
                ...
                linesToFile.Add(rung.RungNo + "," + rungNoHex);
                ...
                var dataTypeBytes = BitConverter.GetBytes(Convert.ToInt16(dataTypeHex, 16));
                ...
                linesToFile.Add(rung.Datatype + "," + (dataTypeBytes != null ? dataTypeHex : "-"));
                ...
                linesToFile.Add(rung.Enable + "," + (enableBytes != null ? enableHex : "-"));
                ...
                linesToFile.Add(rung.Oprator + "," + (opCodeBytes != null ? opcodeHex : "-"));
                ...
                for (var j = 0; j < 8; j++)
                {
                    ...
                    } else
                    {
                        ...
                        linesToFile.Add(rung.Operands[j].TypeOfOperand + "," + (typeOfOpBytes != null ? typeOfOperandHex : "-"));
                        ...
                        linesToFile.Add(rung.Operands[j].OP + "," + (opBytes != null ? opHex : "-"));
                ...
                linesToFile.Add(rung.NoOfOperands + "," + (noOfOperandBytes != null ? noOfOperandHex : "-"));
                ...
                linesToFile.Add(rung.T_CName + "," + (tcNameBytes != null ? tcName : "-"));
                ...
                linesToFile.Add(rung.Output1 + "," + (output1Bytes != null ? output1Hex : "-"));
                ...
                linesToFile.Add(rung.Output2 + "," + (output2Bytes != null ? output2Hex : "-"));

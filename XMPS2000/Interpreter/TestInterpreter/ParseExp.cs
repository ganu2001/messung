...
namespace TestInterpreter
{
    public class ParseExp
    {
        ...
        public static RungOperands GetRungOperands(string rung)
        {
            ...
            List<string> logicalOperatorList = ol.LogicalOperatorsList;
            List<string> arithmeticOperatorList = ol.ArithmeticOperatorsList;
            List<string> timerOperatorList = ol.TimerOperatorsList;
            ...
            foreach(string logical in logicalOperatorList)
            {
            ...
            foreach(string arithmetic in arithmeticOperatorList)
            {
            ...
            foreach(string timer in timerOperatorList)
            {
        ...
        getOperands:
            ...
            switch (optorType)
            {
                case "timer": var op1 = rightExp.Split('(')[1];
                            var op2 = op1.Split(')')[0];
                            op = op2.Split(',');

           ...
           new List<Instruction>() {
               ...
               new Instruction { ID=0x0040, Text="ADD", InstructionType=0x0001,
                   SupportedDataTypes = new List<DataType>() {
                       ...
                       new DataType { ID=0x0005, Text="Real"},
                       new DataType { ID=0x0004, Text="Int"}}},
               new Instruction { ID=0x0050, Text="SUB", InstructionType=0x0001, Operand3Enabled = false, Operand4Enabled = false,
                   SupportedDataTypes = new List<DataType>() {
                       new DataType { ID=0x0001, Text="Byte"},
                       new DataType { ID=0x0002, Text="Word"},
                       new DataType { ID=0x0003, Text="Double Word"},
               ...
               new Instruction { ID=0x0060, Text="MUL", InstructionType=0x0001,
                   SupportedDataTypes = new List<DataType>() {
                       ...
                       new DataType { ID=0x0005, Text="Real"},
                       new DataType { ID=0x0004, Text="Int"}}},
               new Instruction { ID=0x0070, Text="DIV", InstructionType=0x0001, Operand3Enabled = false, Operand4Enabled = false,
                   SupportedDataTypes = new List<DataType>() {
                       new DataType { ID=0x0001, Text="Byte"},
                       new DataType { ID=0x0002, Text="Word"},
                       new DataType { ID=0x0003, Text="Double Word"},
                       new DataType { ID=0x0005, Text="Real"},
                       new DataType { ID=0x0004, Text="Int"}}},
               new Instruction { ID=0x0080, Text="MOD", InstructionType=0x0001, Operand3Enabled = false, Operand4Enabled = false,
                   SupportedDataTypes = new List<DataType>() {
                       new DataType { ID=0x0001, Text="Byte"},
                       new DataType { ID=0x0002, Text="Word"},
                       new DataType { ID=0x0003, Text="Double Word"},
               ...
               // Compare
               new Instruction { ID=0x0110, Text="GT", InstructionType=0x0004, Operand3Enabled = false, Operand4Enabled = false,
                   SupportedDataTypes = new List<DataType>() {
                       new DataType { ID=0x0000, Text="Bool"},
                       new DataType { ID=0x0001, Text="Byte"},
                       new DataType { ID=0x0002, Text="Word"},
